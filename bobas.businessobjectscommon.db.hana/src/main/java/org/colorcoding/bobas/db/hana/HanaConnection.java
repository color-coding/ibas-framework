...
import org.colorcoding.bobas.db.ConnectionUrl;
import org.colorcoding.bobas.db.DbException;
import org.colorcoding.bobas.i18n.i18n;

public class HanaConnection implements Connection, ConnectionUrl {
			...
			if (connection != null) {
				...
				for (int i = 0; i < fields.length; i++) {
					...
					if (fields[i].getName().equals("_inner")) {
						...
						ConnectionSapDBFinalize sapDBFinalize;
						try {
	...
	public HanaConnection(String dbURL, String userName, String dbPassword) throws DbException {
		initialization(dbURL, userName, dbPassword);
	}

	private void initialization(String dbURL, String userName, String dbPassword) throws DbException {
		try {
