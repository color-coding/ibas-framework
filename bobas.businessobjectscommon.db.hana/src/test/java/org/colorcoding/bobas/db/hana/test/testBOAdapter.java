package org.colorcoding.bobas.db.hana.test;

import org.colorcoding.bobas.db.hana.BOAdapter;
...
public class testBOAdapter extends TestCase {
	public void testCriteria() throws BOParseException {
		...
		String sqlString = "SELECT TOP 100 * FROM \"AVA_TT_ORDR\" WHERE (\"DocStatus\" = N'P' OR \"DocStatus\" = N'F') AND \"CardCode\" IS NOT NULL AND CAST(\"DocEntry\" AS NVARCHAR) LIKE N'2%' AND \"DocEntry\" > 2000 AND \"DocEntry\" <> CAST(\"B1DocEntry\" AS INTEGER) ORDER BY \"DocEntry\" DESC, \"CardCode\" ASC";
