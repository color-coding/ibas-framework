...
public class SalesOrder extends BusinessObject<SalesOrder> implements ISalesOrder, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 6231674545373450453L;
	 ...
	 * Instance 属性
	 */
	@DbField(name = "Instance", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 手写 属性
	 */
	@DbField(name = "Handwrtten", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 用户 属性
	 */
	@DbField(name = "UserSign", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 是否结转 属性
	 */
	@DbField(name = "Transfered", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
