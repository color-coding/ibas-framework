...
public class SalesOrder extends BusinessObject<SalesOrder> implements ISalesOrder, IBOUserFields {
	 ...
	 * Instance 属性
	 */
	@DbField(name = "Instance", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 手写 属性
	 */
	@DbField(name = "Handwrtten", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 用户 属性
	 */
	@DbField(name = "UserSign", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 是否结转 属性
	 */
	@DbField(name = "Transfered", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
