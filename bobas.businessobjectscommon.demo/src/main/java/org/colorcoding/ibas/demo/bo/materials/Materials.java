...
public class Materials extends BusinessObject<Materials> implements IMaterials {
	 ...
	 * 物料编号 属性
	 */
	@DbField(name = "ItemCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = true, uniqueKey = true)
	 ...
	 * 订购数量 属性
	 */
@DbField(name = "OnOrder", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
...
public static final IPropertyInfo<BigDecimal> PROPERTY_ONHAND = registerProperty(PROPERTY_ONHAND_NAME,
	 ...
	 * 库存计量单位 属性
	 */
	@DbField(name = "UseBaseUn", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
