...
public class User extends BusinessObject<User> implements IUser {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 97054091624845780L;
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "CC_TT_USER";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "CC_TT_USER";
	 ...
	 * 编码 属性
	 */
	@DbField(name = "UserCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性名称-用户密码
	 */
	private static final String PROPERTY_USERPASSWORD_NAME = "UserPassword";

	/**
	 * 用户密码 属性
	 */
	@DbField(name = "PassWord", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_USERPASSWORD = registerProperty(PROPERTY_USERPASSWORD_NAME,
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_USERPASSWORD_NAME)
	public final String getUserPassword() {
		return this.getProperty(PROPERTY_USERPASSWORD);
	}
	 ...
	 * 属性名称-超级用户
	 */
	private static final String PROPERTY_SUPERUSER_NAME = "SuperUser";

	/**
	 * 超级用户 属性
	 */
	@DbField(name = "SuperUser", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<emYesNo> PROPERTY_SUPERUSER = registerProperty(PROPERTY_SUPERUSER_NAME,
			emYesNo.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_SUPERUSER_NAME)
	public final emYesNo getSuperUser() {
		return this.getProperty(PROPERTY_SUPERUSER);
	}
	 ...
	 * @param value 值
	 */
	public final void setSuperUser(emYesNo value) {
		this.setProperty(PROPERTY_SUPERUSER, value);
	}

	/**
	 * 属性名称-电子邮件地址
	 */
	private static final String PROPERTY_EMAIL_NAME = "eMail";

	/**
	 * 电子邮件地址 属性
	 */
	@DbField(name = "eMail", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_EMAIL = registerProperty(PROPERTY_EMAIL_NAME, String.class,
			MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_EMAIL_NAME)
	public final String geteMail() {
		return this.getProperty(PROPERTY_EMAIL);
	}
