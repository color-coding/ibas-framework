...
public class User extends BusinessObject<User> implements IUser {
	 ...
	 * 编码 属性
	 */
	@DbField(name = "UserCode", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性名称-超级用户
	 */
	private static final String PROPERTY_SUPPERUSER_NAME = "SupperUser";

	/**
	 * 超级用户 属性
	 */
	@DbField(name = "SupperUser", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<emYesNo> PROPERTY_SUPPERUSER = registerProperty(PROPERTY_SUPPERUSER_NAME,
			emYesNo.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_SUPPERUSER_NAME)
	public final emYesNo getSupperUser() {
		return this.getProperty(PROPERTY_SUPPERUSER);
	}
	 ...
	 * 电子邮件地址 属性
	 */
	@DbField(name = "eMail", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
