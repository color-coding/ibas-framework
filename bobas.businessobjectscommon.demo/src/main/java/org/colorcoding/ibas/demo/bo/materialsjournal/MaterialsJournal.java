...
public class MaterialsJournal extends BusinessObject<MaterialsJournal>
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 853618548405712433L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = MaterialsJournal.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "CC_TT_OINM";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "CC_TT_MATERIALSJOURNAL";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "MaterialsJournal";
	 ...
	 * 属性名称-仓库编号
	 */
	private static final String PROPERTY_WAREHOUSECODE_NAME = "WarehouseCode";

	/**
	 * 仓库编号 属性
	 */
	@DbField(name = "WhsCode", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_WAREHOUSECODE = registerProperty(PROPERTY_WAREHOUSECODE_NAME,
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_WAREHOUSECODE_NAME)
	public final String getWarehouseCode() {
		return this.getProperty(PROPERTY_WAREHOUSECODE);
	}
	 ...
	 * 基础单据行 属性
	 */
	@DbField(name = "BaseLinNum", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME)
