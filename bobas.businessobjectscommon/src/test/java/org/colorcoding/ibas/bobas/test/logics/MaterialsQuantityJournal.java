...
public class MaterialsQuantityJournal extends BusinessObject<MaterialsQuantityJournal>
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 4304440898701074124L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = MaterialsQuantityJournal.class;
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "MaterialsQuantityJournal";
