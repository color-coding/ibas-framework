...
public class PurchaseOrder extends BusinessObject<PurchaseOrder> implements IBODocument, IApprovalData, IBOTagCanceled {
	 ...
	 * 
	 */
	public final static IPropertyInfo<PurchaseOrderItems> PROPERTY_PURCHASEORDERITEMS = registerProperty(
			PROPERTY_PURCHASEORDERITEMS_NAME, PurchaseOrderItems.class, MY_CLASS);
	...
	@XmlElement(name = PurchaseOrderItem.BUSINESS_OBJECT_NAME, type = PurchaseOrderItem.class, required = true)
