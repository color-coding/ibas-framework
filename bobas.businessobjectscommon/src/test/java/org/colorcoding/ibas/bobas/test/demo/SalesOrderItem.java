...
public class SalesOrderItem extends BusinessObject<SalesOrderItem>
		implements IBODocumentLine, IBOTagCanceled, IBOUserFields {
	 ...
	 * 显示顺序 属性
	 */
	@DbField(name = "VisOrder", type = DataType.NUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	 ...
	 * 数量 属性
	 */
	@DbField(name = "Quantity", type = DataType.DECIMAL, table = DB_TABLE_NAME)
	 ...
	 * 剩余未清数量 属性
	 */
	@DbField(name = "OpenQty", type = DataType.DECIMAL, table = DB_TABLE_NAME)
	 ...
	 * 单价 属性
	 */
	@DbField(name = "Price", type = DataType.DECIMAL, table = DB_TABLE_NAME)
	 ...
	 * 行总计 属性
	 */
	@DbField(name = "LineTotal", type = DataType.DECIMAL, table = DB_TABLE_NAME)
