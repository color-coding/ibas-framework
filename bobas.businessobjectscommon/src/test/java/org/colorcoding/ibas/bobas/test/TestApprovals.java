...
class ApprovalProcess extends org.colorcoding.ibas.bobas.approval.ApprovalProcess<IProcessData> {

	public ApprovalProcess() {
		super(new ProcessData());
	}
	...
	public ApprovalProcess(IProcessData processData) {
		super(processData);
	}
	...
	private static class ProcessData extends BusinessObject<ProcessData> implements IProcessData {
