...
import org.colorcoding.bobas.expressions.ExpressionFactory;
import org.colorcoding.bobas.expressions.JudgmentLinks;
import org.colorcoding.bobas.messages.RuntimeLog;

/**
 * 业务对象仓库-缓存
 */
class BORepository4Cache extends BORepositoryBase implements IBORepository4Cache {
