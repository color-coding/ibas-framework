...
public class UserFieldFactory {
	...
	volatile private static UserFieldFactory instance = null;

	public static UserFieldFactory create() {
		if (instance == null) {
			synchronized (UserFieldFactory.class) {
				if (instance == null) {
					instance = new UserFieldFactory();
				}
			}
		}
		return instance;
