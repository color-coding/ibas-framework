...
import org.colorcoding.bobas.db.pgsql.BOAdapter;
...
public class testBOAdapter extends TestCase {
	...
	public void testCriteria() throws BOParseException {
		...
		String sqlString = "SELECT * FROM \"AVA_TT_ORDR\" WHERE (\"DocStatus\" = 'P' OR \"DocStatus\" = 'F') AND \"CardCode\" IS NOT NULL AND CAST(\"DocEntry\" AS VARCHAR) LIKE '2%' AND \"DocEntry\" > 2000 AND \"DocEntry\" != CAST(\"B1DocEntry\" AS INTEGER) ORDER BY \"DocEntry\" DESC,\"CardCode\" ASC LIMIT 100";
