package org.colorcoding.bobas.db.mssql.test;
...
public class testDbConnect extends TestCase {
	...
	public void testMsqlConnect() {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select * from ava_sys_user");
